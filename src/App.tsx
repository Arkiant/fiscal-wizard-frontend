...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
          ...
          <div className="text-center">
            ...
            <div className="max-w-2xl mx-auto space-y-3 md:space-y-4">
              ...
              <p className="text-base md:text-lg text-slate-300">
                Genera automáticamente los valores exactos para cada casilla de
                la declaración a partir de tus operaciones Interactive Brokers
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Professional Footer */}
      <footer
        className="mt-20 text-white w-full"
        style={{
          background: "linear-gradient(135deg, #0f172a 0%, #1e293b 100%)",
        }}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm">
                Herramienta automática para el cálculo del IRPF y generación de
                valores específicos para cada casilla de la declaración.
              </p>
